...
/**
 * {@code Eventually} is umbrealla do-nothing annotation. Use nested annoations in simple or
 * qualified form, as you like.
 * @see Eventually.Async
 * @see Eventually.Provides
 */
...
public @interface Eventually {
   ...
   * ListenableFuture&lt;V&gt;} and binding target type will be registered as
   ...
   * Scoping is a serious concern which should be carefully crafted for particular use case. Most
   * safe way to run such group of asynchronous computations is to use {@literal @}Singleton scoped
   ...
   * transformation dispatching when used inside {@link EventualModules#providedBy(Object)}.
   * @see EventualModules
   */
  @Retention(RetentionPolicy.RUNTIME)
  @Qualifier
